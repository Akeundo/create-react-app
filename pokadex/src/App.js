...
import logo from './poka-ball.png';
import './App.css';
      ...
      <div className="App">
        {this.state.activeNow ? (
          <div>
            ...
            <p>
              ...
              :{this.state.activeNow.name} has{' '}
              {this.state.activeNow.abilities.length} abilities And it is of
              type {this.state.activeNow.types[0].type.name} pokemon
            </p>
          </div>
        ) : (
          <div></div>
        ...
        {this.state.loaded ? (
          this.state.pokemons.map((pokemon, index) => {
            return (
              <div className="pokemon" key={index} onClick={this.fetchDetails}>
                {pokemon}
              </div>
            );
          })
